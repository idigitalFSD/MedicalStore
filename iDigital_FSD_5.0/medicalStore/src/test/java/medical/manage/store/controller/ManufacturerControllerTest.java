...
public class ManufacturerControllerTest {
	...
	@Test
	public void viewAllManufacturerTest() throws Exception {
		MvcResult result  = mockMvc.perform(get("/manufacturer/view_all_manufacturers").content(MediaType.APPLICATION_JSON_VALUE))
	...
	@Test
	public void addManufacturerTest() throws Exception {
		...
		MvcResult result = mockMvc.perform(post("/add_manufacturer").content(jsonRequest)
